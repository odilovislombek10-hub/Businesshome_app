...
abstract final class SiteIcons {
  ...
  /// `my-location-button.component.ts` — "Google Maps stili" nishon.
  static const crosshair = SiteIconData([
  ...
  static const thermometer = SiteIconData(['M14 4v10.54a4 4 0 1 1-4 0V4a2 2 0 0 1 4 0Z']);
